...
const QuizEdit3 = () => {
    ...
    function createGrid() {
        ...
        for (let i = 0; i < nrOfRows + nr_of_newrows; i++) {
            buttons.push(<button className='small-button margin-large' onClick={() => removeRow(i)}>Remove row</button>)
        }
                ...
                <div className='col-8 d-flex flex-column justify-content-start align-self-start'>
                    ...
                    <div className="d-flex justify-content-between p-3">
                        ...
                        <div className='d-flex align-self-end'>
                            <button onClick={saveStep3} className="btn btn-warning me-3">Save</button>
                            <button onClick={nextStep} className="btn btn-primary">Finish</button>
                        </div>
                    </div>
                </div>
            </div>
